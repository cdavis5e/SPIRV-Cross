...
kernel void main0(main0_in in [[stage_in]], constant spvAux& spvAuxBuffer [[buffer(30)]], uint gl_InvocationID [[thread_index_in_threadgroup]], uint gl_PrimitiveID [[threadgroup_position_in_grid]], device main0_out* spvOut [[buffer(29)]], device main0_patchOut* spvPatchOut [[buffer(28)]], device MTLQuadTessellationFactorsHalf* spvTessLevel [[buffer(27)]], threadgroup main0_in* gl_in [[threadgroup(0)]])
{
    device main0_out* gl_out = &spvOut[gl_PrimitiveID * 1];
    device main0_patchOut& patchOut = spvPatchOut[gl_PrimitiveID];
    if (gl_InvocationID < spvAuxBuffer.vertexCount)
