...
kernel void main0(constant spvAux& spvAuxBuffer [[buffer(30)]], uint gl_InvocationID [[thread_index_in_threadgroup]], uint gl_PrimitiveID [[threadgroup_position_in_grid]], device main0_patchOut* spvPatchOut [[buffer(28)]], device MTLQuadTessellationFactorsHalf* spvTessLevel [[buffer(27)]])
{
